...
export default function AuthBrandPanel() {
  ...
  return (
    <div className="hidden lg:flex lg:w-1/2 xl:w-[55%] relative flex-col justify-between p-10 xl:p-14 bg-gradient-to-b from-[#030712] via-[#090d16] to-[#030712] border-r border-white/[0.05] overflow-hidden min-h-screen">
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="font-bold text-xl text-white tracking-tight font-sans">AITradeJournal</span>
              <span className="text-[10px] uppercase font-bold tracking-widest px-1.5 py-0.5 rounded bg-blue-500/15 text-blue-400 border border-blue-500/20">PRO</span>
            </div>
            <p className="text-xs text-slate-400 font-medium">Smart journaling for institutional performance</p>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 my-auto py-10 space-y-12">
        ...
        <div className="relative w-full max-w-lg rounded-2xl border border-white/[0.08] bg-slate-950/40 backdrop-blur-md p-5 shadow-2xl overflow-hidden group">
          ...
          <motion.div
            ...
            className="absolute top-[55px] right-[25px] flex items-center gap-2 bg-slate-900/90 backdrop-blur-md border border-emerald-500/20 px-3 py-1.5 rounded-xl shadow-[0_4px_20px_rgba(16,185,129,0.15)] cursor-pointer"
          >
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.05 }}
            className="absolute bottom-[35px] left-[25px] flex items-center gap-2 bg-slate-900/90 backdrop-blur-md border border-blue-500/20 px-3 py-1.5 rounded-xl shadow-[0_4px_20px_rgba(59,130,246,0.15)] cursor-pointer"
          >
          ...
          <motion.div
            ...
            className="absolute top-[135px] left-[175px] pointer-events-none hidden md:flex items-center gap-1.5 bg-slate-950/80 backdrop-blur-sm border border-white/[0.04] px-2 py-0.5 rounded-full text-[10px] font-mono text-slate-400"
          >
        ...
        {/* 4 Feature Cards (Glassmorphism layout) */}
        <div className="space-y-3.5 max-w-lg">
          {features.map((feat, idx) => (
            <motion.div
              ...
              className={`flex items-start gap-4 p-3.5 rounded-xl border border-white/[0.03] bg-white/[0.015] backdrop-blur-sm transition-all duration-200 cursor-pointer group ${feat.glowColor}`}
            >
              <div className={`p-2 rounded-lg flex-shrink-0 mt-0.5 transition-transform group-hover:scale-110 ${feat.iconBg}`}>
                {feat.icon}
              </div>
      ...
      <div className="relative z-10 max-w-lg mt-auto pt-6 border-t border-white/[0.05]">
        <div className="relative bg-white/[0.015] backdrop-blur-sm border border-white/[0.04] rounded-2xl p-4 shadow-xl">
          <Quote className="absolute -top-3.5 -left-1 text-blue-500/20 fill-blue-500/5 stroke-[1.5px]" size={36} />
          <p className="text-xs text-slate-300 font-medium leading-relaxed italic relative z-10">
          ...
          <div className="flex items-center gap-3 mt-3.5 pt-3 border-t border-white/[0.04]">
            <div className="h-7 w-7 rounded-full bg-gradient-to-tr from-blue-500 to-indigo-600 flex items-center justify-center text-[10px] font-extrabold text-white shadow-md border border-blue-400/20">
              SJ
            </div>
            <div>
              <p className="text-[11px] font-bold text-white tracking-wide">Sarah Jenkins</p>
              <p className="text-[9px] text-slate-400 font-medium">Professional FX Futures Trader</p>
            </div>
            <div className="ml-auto flex items-center gap-1">
              {[...Array(5)].map((_, i) => (
                <svg key={i} className="h-2.5 w-2.5 text-amber-400 fill-amber-400 shadow-glow" viewBox="0 0 20 20">
