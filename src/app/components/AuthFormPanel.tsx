    ...
    >
      {(['login', 'signup'] as AuthTab[]).map((tab) => (
        <button
          ...
          aria-label={tab === 'login' ? t('auth.login.tab') : t('auth.signup.tab')}
        ...
        >
          ...
          {tab === 'login' ? t('auth.login.tab') : t('auth.signup.tab')}
        </button>
      ))}
    </div>
  );
  ...
  const cardBody = (
    <>
      ...
      <motion.div
        ...
        className="lg:hidden flex flex-col items-center justify-center mb-5 text-center"
      >
        ...
        <p className="text-[10px] text-slate-400 font-medium mt-0.5">{t('auth.tagline')}</p>
      </motion.div>

      {/* Header Title — animates text only, not the tab row */}
      <motion.div variants={itemVariants} className="text-center mb-5">
        <h2 className="text-2xl font-bold text-white tracking-tight">
          {activeTab === 'login' ? t('auth.login.title') : t('auth.signup.title')}
        </h2>
      ...
      <div className="sticky top-0 z-20 bg-slate-950/70 backdrop-blur-xl">{TabSwitcher}</div>
      ...
      <div className="flex items-center justify-center w-full">
        <motion.button
          ...
          title={t('auth.googleButtonTitle')}
        >
          {isGoogleLoading ? (
            <>
            ...
            {!isFocused && (
              ...
              >
                ...
                <div className="shrink-0">
                  <motion.div
                    variants={itemVariants}
                    className="lg:hidden flex flex-col items-center justify-center mb-4 sm:mb-5 text-center"
                  >
                    <div className="p-2.5 rounded-xl bg-gradient-to-tr from-blue-600/20 to-indigo-600/10 border border-blue-500/20 shadow-lg mb-2">
                      <AppLogo size={28} />
                    </div>
          ...
          <>
            ...
            >
              ...
              <motion.div
                ...
                animate={{ scale: 1.02, transition: { ...LAYOUT_SPRING, delay: 0.05 } }}
                    ...
                    {activeTab === 'login' ? (
                      ...
                      >
                        ...
                        <div className="space-y-1.5">
                          <label
                            className="block text-[10px] font-bold uppercase tracking-widest text-slate-400"
                            htmlFor="login-password-focused"
                          >
                            Password
                          </label>
                          <div className="relative flex items-center group/input">
                      ...
                      >
                        <div className="space-y-1.5">
                          <label
                            className="block text-[10px] font-bold uppercase tracking-widest text-slate-400"
                            htmlFor="signup-fullname-focused"
                          >
                            Full Name
                          </label>
                          <div className="relative flex items-center group/input">
                        ...
                        <div className="space-y-1.5">
                          <label
                            className="block text-[10px] font-bold uppercase tracking-widest text-slate-400"
                            htmlFor="signup-username-focused"
                          >
                            Username
                          </label>
                          <div className="relative flex items-center group/input">
                        ...
                        <div className="space-y-1.5">
                          <label
                            className="block text-[10px] font-bold uppercase tracking-widest text-slate-400"
                            htmlFor="signup-password-focused"
                          >
                            Password
                          </label>
                          <div className="relative flex items-center group/input">
                        ...
                        <div className="space-y-1.5">
                          <label
                            className="block text-[10px] font-bold uppercase tracking-widest text-slate-400"
                            htmlFor="signup-confirm-password-focused"
                          >
                            Confirm Password
                          </label>
                          <div className="relative flex items-center group/input">
                        ...
                        <div className="grid grid-cols-2 gap-3 sm:gap-4">
                          <div className="space-y-1.5">
                            <label
                              className="block text-[10px] font-bold uppercase tracking-widest text-slate-400"
                              htmlFor="signup-experience-focused"
                            >
                              Experience
                            </label>
                            <div className="relative flex items-center group/input">
                        ...
                        <div className="space-y-1.5">
                          <label
                            className="block text-[10px] font-bold uppercase tracking-widest text-slate-400"
                            htmlFor="signup-country-focused"
                          >
                            Country
                          </label>
                          <div className="relative flex items-center group/input">
