    ...
    <div className="flex-1 h-full overflow-y-auto bg-gradient-to-b from-[#02040a] via-[#050814] to-[#02040a]">
      <div className="min-h-full w-full flex items-center justify-center p-4 sm:p-6 lg:p-8 xl:p-10 relative overflow-hidden">
          ...
          {activeTab === 'login' ? (
            ...
            >
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                <button
                  type="button"
                  onClick={() => toast.info('Password recovery link dispatched to administrator.')}
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  <label className="block text-[9px] font-bold uppercase tracking-wider text-slate-400" htmlFor="signup-fullname">
                    Full Name
                  </label>
                  <div className="relative flex items-center group/input">
                    <User size={13} className="absolute left-3 text-slate-500 transition-colors group-focus-within/input:text-blue-400" />
                    <input
                      id="signup-fullname"
                      type="text"
                  ...
                  {signupForm.formState.errors.fullName && (
                    <p className="text-[9px] text-red-400 font-semibold">{signupForm.formState.errors.fullName.message}</p>
                  )}
                </div>
                <div className="space-y-1">
                  <label className="block text-[9px] font-bold uppercase tracking-wider text-slate-400" htmlFor="signup-username">
                    Username
                  </label>
                  <div className="relative flex items-center group/input">
                    <span className="absolute left-3 text-[11px] font-bold text-slate-500 transition-colors group-focus-within/input:text-blue-400">@</span>
                    <input
                      id="signup-username"
                      type="text"
                  ...
                  {signupForm.formState.errors.username && (
                    <p className="text-[9px] text-red-400 font-semibold">{signupForm.formState.errors.username.message}</p>
                  )}
                </div>
              </div>
              ...
              {/* Email Field */}
              <div className="space-y-1">
                <label className="block text-[9px] font-bold uppercase tracking-wider text-slate-400" htmlFor="signup-email">
                  Email Address
                </label>
                <div className="relative flex items-center group/input">
                  <Mail size={13} className="absolute left-3.5 text-slate-500 transition-colors group-focus-within/input:text-blue-400" />
                  <input
                    id="signup-email"
                    type="email"
                    placeholder="name@domain.com"
                ...
                {signupForm.formState.errors.email && (
                  <p className="text-[9px] text-red-400 font-semibold">{signupForm.formState.errors.email.message}</p>
                )}
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  <label className="block text-[9px] font-bold uppercase tracking-wider text-slate-400" htmlFor="signup-password">
                    Password
                  </label>
                  <div className="relative flex items-center group/input">
                    <Lock size={13} className="absolute left-3 text-slate-500 transition-colors group-focus-within/input:text-blue-400" />
                    <input
                      id="signup-password"
                      type={showPassword ? 'text' : 'password'}
                  ...
                  {signupForm.formState.errors.password && (
                    <p className="text-[9px] text-red-400 font-semibold">{signupForm.formState.errors.password.message}</p>
                  )}
                </div>
                <div className="space-y-1">
                  <label className="block text-[9px] font-bold uppercase tracking-wider text-slate-400" htmlFor="signup-confirm">
                    Confirm
                  </label>
                  <div className="relative flex items-center group/input">
                    <Lock size={13} className="absolute left-3 text-slate-500 transition-colors group-focus-within/input:text-blue-400" />
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  <label className="block text-[9px] font-bold uppercase tracking-wider text-slate-400" htmlFor="signup-exp">
                    Experience Level
                  </label>
                  <div className="relative flex items-center group/select">
                    <Sparkles size={13} className="absolute left-3 text-slate-500 transition-colors group-focus-within/select:text-blue-400 pointer-events-none" />
                    <select
                      id="signup-exp"
                    ...
                    >
                      <option value="" className="bg-[#0b0f19]">Select level</option>
                ...
                <div className="space-y-1">
                  <label className="block text-[9px] font-bold uppercase tracking-wider text-slate-400" htmlFor="signup-style">
                    Trading Style
                  </label>
                  <div className="relative flex items-center group/select">
                    <ChevronDown size={12} className="absolute right-3 text-slate-500 pointer-events-none" />
                    ...
                    >
                      <option value="" className="bg-[#0b0f19]">Select style</option>
                      {tradingStyles.map((s) => (
                  ...
                  {signupForm.formState.errors.tradingStyle && (
                    <p className="text-[9px] text-red-400 font-semibold">{signupForm.formState.errors.tradingStyle.message}</p>
                  )}
                </div>
              </div>
              ...
              {/* Country Selection */}
              <div className="space-y-1">
                <label className="block text-[9px] font-bold uppercase tracking-wider text-slate-400" htmlFor="signup-country">
                  Country of Residence
                </label>
                <div className="relative flex items-center group/select">
                  <Globe size={13} className="absolute left-3 text-slate-500 transition-colors group-focus-within/select:text-blue-400 pointer-events-none" />
                  <select
                    id="signup-country"
                    className="w-full bg-slate-950/60 border border-white/[0.07] hover:border-white/[0.12] focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/15 rounded-xl pl-8 pr-8 py-2.5 text-xs text-white placeholder-slate-500 focus:outline-none transition-all font-sans font-medium appearance-none cursor-pointer"
                    {...signupForm.register('country', { required: 'Select country' })}
                  >
                    <option value="" className="bg-[#0b0f19]">Select residence</option>
                    {countries.map((c) => (
                ...
                {signupForm.formState.errors.country && (
                  <p className="text-[9px] text-red-400 font-semibold">{signupForm.formState.errors.country.message}</p>
                )}
              </div>
        ...
        <div className="grid grid-cols-3 gap-2.5">
          ...
          >
            <svg className="w-4 h-4 text-slate-300 transition-transform group-hover:scale-110" viewBox="0 0 23 23" fill="currentColor">
