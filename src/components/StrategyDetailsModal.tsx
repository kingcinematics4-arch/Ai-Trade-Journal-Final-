  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div className="fixed inset-0 bg-black/70 backdrop-blur-sm" onClick={onClose} />
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 scrollbar-none">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div className="card-premium p-4 text-center">
                  ...
                  <h4 className="text-xl font-bold text-blue-500 mt-2">
                ...
                <div className="card-premium p-4 text-center">
                  ...
                  <h4 className={`text-xl font-bold ${pnlColorClass} mt-2`}>
                ...
                <div className="card-premium p-4 text-center">
                  ...
                  <h4 className="text-xl font-bold text-white mt-2">
                    ${(strategy.netPnL / strategy.totalTrades).toFixed(2)}
                  </h4>
                </div>
                <div className="card-premium p-4 text-center">
                  <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">
                  ...
                  <h4 className="text-xl font-bold text-emerald-500 mt-2">
                    ${strategy.largestWin.toFixed(2)}
                  </h4>
                </div>
                <div className="card-premium p-4 text-center">
                  <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">
                  ...
                  <h4 className="text-xl font-bold text-rose-500 mt-2">
                    ${strategy.largestLoss.toFixed(2)}
                  </h4>
                </div>
              </div>
                ...
                {strategy.trades && strategy.trades.length > 0 ? (
                  <ul className="space-y-3">
                    {strategy.trades.slice(0, 5).map((trade: any) => (
                      <li
                        key={trade.id}
                        className="flex items-center justify-between bg-white/[0.02] p-3 rounded-xl border border-white/[0.05]"
                      >
                        <span className="text-sm font-medium text-white">{trade.trade_title}</span>
                        <span
                          className={`text-sm font-bold ${parseFloat(trade.pnl_amount) >= 0 ? 'text-emerald-500' : 'text-rose-500'}`}
                        >
                  ...
                  <p className="text-muted-foreground text-sm">
                    No recent trades for this strategy.
                  </p>
                )}
              </div>
              ...
              <div className="card-premium p-6">
                ...
                <p className="text-muted-foreground text-sm">
                  Monthly performance chart for {strategy.name} would go here.
                </p>
              </div>
            </div>
          </motion.div>
