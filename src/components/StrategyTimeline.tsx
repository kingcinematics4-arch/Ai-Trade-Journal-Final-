  ...
  return (
    <div className="card-premium p-6 overflow-hidden flex flex-col h-full">
      <div className="flex items-center justify-between mb-8">
        <h3 className="text-sm font-bold text-white uppercase tracking-widest opacity-50">Daily Strategy Flow</h3>
        ...
        {timeline.slice(0, 10).map((day, i) => (
          ...
          >
            ...
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-black text-white uppercase tracking-wider">{format(new Date(day.date), 'dd MMMM yyyy')}</span>
              <span className="text-[10px] font-black text-muted-foreground bg-white/[0.03] px-2 py-0.5 rounded-full">{day.totalTrades} Trades</span>
            </div>
