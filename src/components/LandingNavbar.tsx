...
export default function LandingNavbar() {
  ...
  const navLinks = [{ name: t('landing.features.title'), href: '#features', type: 'scroll' }];
  ...
  return (
    <nav
      className={cn(
        ...
        isScrolled
          ? 'bg-[#050816]/80 backdrop-blur-xl border-b border-white/[0.05] py-4'
          : 'bg-transparent'
      )}
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[8px] font-black text-blue-500 uppercase tracking-[0.3em] leading-none">
